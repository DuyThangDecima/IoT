...
def ajax():
    ...
    # Kiểu lấy dữ liệu : visits hoặc là return
    ...
    return statsSummary(region, startTime, endTime, resolution, charType)


def statsSummary(region, startTime, endTime, resolution, charType):
    if region != "0":
